...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %bar_result, metadata !168, metadata !16), !dbg !169
  %call1 = call i32 @bar(), !dbg !170
  store i32 %call1, i32* %bar_result, align 4, !dbg !169
  ret i32 0, !dbg !171
}
...
!6 = !DIFile(filename: "c-code/example_mod1.c", directory: "/mnt/Documents/work/university/muni/msc/thesis/APEX/src")
...
!163 = !DILocation(line: 16, column: 9, scope: !161)
!164 = !DILocalVariable(name: "foo_result", scope: !161, file: !6, line: 17, type: !14)
!165 = !DILocation(line: 17, column: 9, scope: !161)
!166 = !DILocation(line: 17, column: 26, scope: !161)
!167 = !DILocation(line: 17, column: 22, scope: !161)
!168 = !DILocalVariable(name: "bar_result", scope: !161, file: !6, line: 18, type: !14)
!169 = !DILocation(line: 18, column: 9, scope: !161)
!170 = !DILocation(line: 18, column: 22, scope: !161)
!171 = !DILocation(line: 20, column: 5, scope: !161)
