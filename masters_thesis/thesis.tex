...
Kristína, Grandma, Lukáš, Maroš, Palo and others that I forgot to mention.
Thank you.
\end{ThesisThanks}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1.0\textwidth]{images/experiments/mod2_linked.pdf}
    \caption{
    \mintinline{text}{example_mod2.c}
    After linking.
    }
...
$ python apex.py examples/experiments/example_mod2/example_mod2.bc example_mod2.c 2
$ ./extracted
20
\end{minted}
