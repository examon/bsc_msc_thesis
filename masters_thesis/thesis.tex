...
% next point
The target line number \textbf{7} from the \mintinline{text}{example.c}
corresponds to the line \textbf{16} from the \mintinline{text}{example.s}.
...
We can see from the computed call graph, that \mintinline{llvm}{@foo} is being
called from the \emph{yellow} component, and \mintinline{llvm}{@bar} is being
