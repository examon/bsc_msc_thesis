...
in the following section \autoref{sec:llvm-ir}).
\item After the first phase, IR code is optionally put through
optimization phase.  Optimizer can use various analysis and transform passes to
improve the code and emits modified IR.
...
\emph{LLVM assembly language is a Static Single Assignment (SSA) based
